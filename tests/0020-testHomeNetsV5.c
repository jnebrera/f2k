...
static int prepare_test_nf5_home_nets_normalize(void **state) {
	...
	static const struct checkdata checkdata1[] = {
			{.size = RD_ARRAYSIZE(checkdata_values1_0),
			 .checks = checkdata_values1_0},
			{.size = RD_ARRAYSIZE(checkdata_values1_1),
			 .checks = checkdata_values1_1},
			{.size = RD_ARRAYSIZE(checkdata_values1_2),
			 .checks = checkdata_values1_2},
			{.size = RD_ARRAYSIZE(checkdata_values1_3),
			 .checks = checkdata_values1_3},
			{.size = RD_ARRAYSIZE(checkdata_values1_4),
			 .checks = checkdata_values1_4},
			{.size = RD_ARRAYSIZE(checkdata_values1_5),
			 .checks = checkdata_values1_5},
	};

	static const struct checkdata checkdata2[] = {
			{.size = RD_ARRAYSIZE(checkdata_values2_0),
			 .checks = checkdata_values2_0},
	};

	return prepare_test_nf5_home_nets_0(state,
					    true,
					    checkdata1,
					    RD_ARRAYSIZE(checkdata1),
					    checkdata2,
					    RD_ARRAYSIZE(checkdata2));
}
