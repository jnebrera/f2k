...
#define INTERFACE_NAME(num)                                                    \
	'e', 't', 'h', 'e', 'r', 'n', 'e', 't', '0', '/', num, 0x00, 0x00,     \
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

#define INTERFACE_DESCRIPTION(num)                                             \
	'e', 't', 'h', 'e', 'r', 'n', 'e', 't', '0', '/', num, 'd', 0x00,      \
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  \
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  \
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  \
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  \
...
#define CHECKDATA(left_name,                                                   \
		  left_snmp,                                                   \
		  left_snmp_name,                                              \
		  left_snmp_description,                                       \
		  right_name,                                                  \
		  right_snmp,                                                  \
		  right_snmp_name,                                             \
		  right_snmp_description)                                      \
	{                                                                      \
		{.key = left_name, .value = left_snmp},                        \
				{.key = left_name "_name",                     \
				 .value = left_snmp_name},                     \
				{.key = left_name "_description",              \
				 .value = left_snmp_description},              \
				{.key = right_name, .value = right_snmp},      \
				{.key = right_name "_name",                    \
				 .value = right_snmp_name},                    \
		{                                                              \
			.key = right_name "_description",                      \
			.value = right_snmp_description                        \
		}                                                              \
	}

	static const struct checkdata_value checkdata1[] =
			CHECKDATA("input_snmp",
				  "1",
				  "1",
				  "1",
				  "output_snmp",
